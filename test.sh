...
assert 4 "int main() { int a=1; a<<=2; return a;}"
assert 1 "int main() { int a=4; a>>=2; return a;}"
assert 1 "int main() { int a=1; a&=3; return a;}"
assert 2 "int main() { int a=1; a^=3; return a;}"
assert 3 "int main() { int a=1; a|=2; return a;}"
