...
test_self: mycc
	...
	# ./mycc analyze.c > tmp.s && cc tmp.s -c -o analyze_self.o;
	# ./mycc codegen.c > tmp.s && cc tmp.s -c -o codegen_self.o;
	./mycc main.c > tmp.s && cc tmp.s -c -o main_self.o;
	# ./mycc parse.c > tmp.s && cc tmp.s -c -o parse_self.o;
	# ./mycc preprocess.c > tmp.s && cc tmp.s -c -o preprocess_self.o;
	# ./mycc tokenize.c > tmp.s && cc tmp.s -c -o tokenize_self.o;
	# ./mycc util.c > tmp.s && cc tmp.s -c -o util_self.o;
	...
	# ./mycc_2nd analyze.c > tmp.s && cc tmp.s -c -o analyze_self.o;
	# ./mycc_2nd codegen.c > tmp.s && cc tmp.s -c -o codegen_self.o;
	./mycc_2nd main.c > tmp.s && cc tmp.s -c -o main_self.o;
	# ./mycc_2nd parse.c > tmp.s && cc tmp.s -c -o parse_self.o;
	# ./mycc_2nd preprocess.c > tmp.s && cc tmp.s -c -o preprocess_self.o;
	# ./mycc_2nd tokenize.c > tmp.s && cc tmp.s -c -o tokenize_self.o;
	# ./mycc_2nd util.c > tmp.s && cc tmp.s -c -o util_self.o;
